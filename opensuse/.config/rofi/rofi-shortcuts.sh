...
keybinds_conf="$HOME/.config/rofi/keybinds.conf"
sway_keybinds_conf="$HOME/.config/rofi/sway.conf "
# laptop_conf="$HOME/.config/hypr/UserConfigs/Laptops.conf"
rofi_theme="$HOME/.config/rofi/config-shortcuts.rasi"
msg='Clicking with Mouse or Pressing ENTER will have NO function'

# combine the contents of the keybinds files and filter for keybinds
keybinds=$(cat "$keybinds_conf" "$sway_keybinds_conf" | grep -E '^bind')
